        ...
        <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-4 col-12">
                <div class="form-group">
                  <label for="paivittainenTyoaika" v-tooltip="'Sopimusten mukainen säännöllinen työaika per päivä. Yleensä 7,5h ilman lounastaukoa tai 8h lounastauon kanssa. Muista täten varmistaa, tuleeko organisaatiossanne merkata myös lounasajat kalenteriin, jotta raportin ylityölukemat pitävät paikkansa.'">Päivittäinen työaika <i class="red fas fa-question-circle"></i></label>
                  <select class="form-control" name="paivittainenTyoaika" id="paivittainenTyoaika" v-model="paivittainenTyoaika" v-on:change="validateSelectionsAndRunQuery">
                    <option :key="n" v-for="n in 96" :value="n-1" :selected="n == 25 ? 'selected' : false">
                      {{ decimalHoursToString(((n-1)/4)) }}
                    </option>
                  </select>
                </div>
                    ...
                    <table v-bind:style="[((yotyoLoppu > iltatyoAlku) || (iltatyoAlku > iltatyoLoppu)) ? {color: 'red'} : null]" id="raportti" class="table table-hover table-sm">
                        ...
                        <tfoot v-if="resultRows.length != 0">
                          <tr>
                            ...
                            <td>{{ (ylityoTotal) ? ylityoTotal : 0 }}</td>
                            <td></td>
                          </tr>
                        </tfoot>
                    </table>
          ...
          axios.get('/sovellus/reports', {
            ...
            if (res.data) {
              ...
              res.data.map(resultRow => {
                ...
                resultRow.ylityo = (resultRow.dailyTotal - (this.paivittainenTyoaika / 4) > 0 ? (resultRow.dailyTotal - this.paivittainenTyoaika / 4) : null)
